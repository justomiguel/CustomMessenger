...
public class ContactsController {
    ...
    public void checkAppAccount() {
        ...
        Account[] accounts = am.getAccountsByType("com.jmv.frre.moduloestudiante.account");
        ...
        if (recreateAccount) {
            ...
            if (UserConfig.isClientActivated()) {
                try {
                    currentAccount = new Account(UserConfig.getCurrentUser().phone, "com.jmv.frre.moduloestudiante.account");
...
//        query.add(builder.build());
        ...
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.com.jmv.frre.moduloestudiante.messenger.android.profile");
