...
JNIEXPORT int Java_com_jmv_frre_moduloestudiante_android_MediaController_startRecord(JNIEnv *env, jclass class, jstring path) {
...
JNIEXPORT int Java_com_jmv_frre_moduloestudiante_android_MediaController_writeFrame(JNIEnv *env, jclass class, jobject frame, jint len) {
    jbyte *frameBytes = (*env)->GetDirectBufferAddress(env, frame);
    return writeFrame(frameBytes, len);
}

JNIEXPORT void Java_com_jmv_frre_moduloestudiante_android_MediaController_stopRecord(JNIEnv *env, jclass class) {
    cleanupRecorder();
}
...
JNIEXPORT jlong Java_com_jmv_frre_moduloestudiante_android_MediaController_getTotalPcmDuration(JNIEnv *env, jclass class) {
    return _totalPcmDuration;
}

JNIEXPORT void Java_com_jmv_frre_moduloestudiante_android_MediaController_readOpusFile(JNIEnv *env, jclass class, jobject buffer, jint capacity, jintArray args) {
...
JNIEXPORT int Java_com_jmv_frre_moduloestudiante_android_MediaController_seekOpusFile(JNIEnv *env, jclass class, jfloat position) {
    return seekPlayer(position);
}

JNIEXPORT int Java_com_jmv_frre_moduloestudiante_android_MediaController_openOpusFile(JNIEnv *env, jclass class, jstring path) {
    const char *pathStr = (*env)->GetStringUTFChars(env, path, 0);
...
JNIEXPORT void Java_com_jmv_frre_moduloestudiante_android_MediaController_closeOpusFile(JNIEnv *env, jclass class) {
    cleanupPlayer();
}

JNIEXPORT int Java_com_jmv_frre_moduloestudiante_android_MediaController_isOpusFile(JNIEnv *env, jclass class, jstring path) {
    const char *pathStr = (*env)->GetStringUTFChars(env, path, 0);
