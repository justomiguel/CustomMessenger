...
JNIEXPORT int Java_com_jmv_frre_moduloestudiante_messenger_Utilities_convertVideoFrame(JNIEnv *env, jclass class, jobject src, jobject dest, int destFormat, int width, int height, int padding, int swap) {
