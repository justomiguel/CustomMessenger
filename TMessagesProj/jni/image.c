...
JNIEXPORT void Java_com_jmv_frre_moduloestudiante_messenger_Utilities_blurBitmap(JNIEnv *env, jclass class, jobject bitmap, int radius) {
    if (!bitmap) {
        return;
    }
...
JNIEXPORT void Java_com_jmv_frre_moduloestudiante_messenger_Utilities_loadBitmap(JNIEnv *env, jclass class, jstring path, jintArray bitmap, int scale, int format, int width, int height) {
